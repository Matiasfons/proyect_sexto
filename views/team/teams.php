            ...
            <div class="modal-content">
                <form method="post" id="form_equipo">
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="btn_creation" class="btn btn-primary" onclick="postTeam(event)"> >Guardar</button>
            ...
            <div class="modal-content">
                <form method="post" id="form_equipo">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="names">Nombres</label>
                            <input type="text" required class="form-control" id="namesU" name="names" placeholder="Nombres">
                        </div>
                        <div class="form-group">
                            <label for="lastName">Apellidos</label>
                            <input type="text" required class="form-control" id="lastNameU" name="lastName" placeholder="Apellidos">
                        </div>
                        <div class="form-group">
                            <label for="Identification">Identification</label>
                            <input type="text" required class="form-control" id="identificationU" name="identification" placeholder="Identification">
                        </div>
                        <div class="form-group">
                            <label for="email">Correo</label>
                            <input type="text" required class="form-control" id="emailU" name="email" placeholder="Email">
                            <div class="alert alert-danger d-none" role="alert" id="CorreoRepetido">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="Area">Area</label>
                            <select name="Area" id="areaU" class="form-control">
                                <option value="Ventas">Ventas</option>
                                <option value="Soporte">Soporte</option>
                                <option value="Administrativo">Administrativo</option>
                            </select>
                    ...
                    <div class="modal-footer">
                        <button type="submit"  class="btn btn-primary" onclick="update(event)"> >Actualizar</button>
